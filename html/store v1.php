<?php
   ...
   require_once('dbConnection.php');
     $sql="SELECT * FROM store ORDER BY scriptName ASC";
...
?>
    ...
    <body>
        ...
        <div class="container1" align="center">
             <table align="center" border="1px"  style="background-color: #f0f8ff; width:600px; line-height:40px;>
                  <tr>
				   <th colspan="4"><h2>Store</h2></th>				   
				  </tr> 
        ...
        ?>
          <tr align="center" colspan="4"> 
				...
				<td><?php echo $row['scriptID']; ?> </td>
				<td><?php echo ('<a href="preview.php?sname=' . $scriptName . '">' . $scriptName . '</a>'); ?> </td>
