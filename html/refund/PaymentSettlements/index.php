...
<html>
    <head>
        <title>Paypal Settlements and Refunds</title>
    ...
    <body>
        <div id = "main">
            <h1>Paypal Settlements and Refunds</h1>
            <div id = "container">
                ...
                <div class="fg-row">
                    <form action="index.php" method="POST" id="myform" >
                        <div class="col-md-10 nopadding">
                            ...
                            <input class="fg-fw text fg-input" placeholder="" type="text" onclick="" name="transID" value="<?php echo $_REQUEST["TID"]; ?>">
