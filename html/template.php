...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){
        ...
        if(x < max_fields){
            x++;
            $(wrapper).append('    <div class="col-sm-4"> <div class="panel panel-primary"><div class="panel-heading">Answear </div><div class="panel-body">  <input type="text" id="txtbox"></div></div> </div>'); //add input box
        }
		else
		{
...
<form name="input" method="post" action="currentScripts.php">
