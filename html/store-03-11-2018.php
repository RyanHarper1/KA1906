         ...
         ?>
              <tr>
               ...
               <td style="color: #347AB6; text-decoration: underline; ">
                  <?php echo '<a href="preview.php?script=' . $scriptid . '&price=' . $price . '&createddate=' . $createdDate . '&rating=' .$rating . '&category=' . $category . '&scriptName=' . $scriptname . '&question=' . $question . '&counters=0">' . $scriptname . '</a>'; ?>
