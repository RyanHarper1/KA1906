...
<html lang="en">
   ...
   <body>
     <nav class="navbar navbar-inverse">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">your scripts  </div>
  ...
  //check user is logged in
	if (!isset($_SESSION["who"])){
     ...
     //Get Script ID
     $sqlScript = "SELECT * Sname FROM script WHERE userId = '$userId'" ;
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		 ...
		 echo "<br> userID: ". $row["userID"]. " - Script: ". $row["id"]. " " . " - ScriptName: ". $row["Sname"] . "<br>";
    }
} else {
    echo "0 results";
}
