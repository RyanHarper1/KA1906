    ...
    $(document).ready(function(){      
      ...
      $('#add').click(function(){  
	   ...
	   $('#add1').click(function(e){  
	    e.preventDefault();
           ...
           $('#dynamic_field1').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="name1[]" placeholder="Please enter script" class="form-control name_list" required /></td></tr>');  
            }
		else
		{
      ...
      $('#submit').click(function(){            
           ...
           $.ajax({  
                ...
                data:$('#add_name', '#txtbox1').serialize(),
