...
<form method="post" action="registration.php" accept-charset='UTF-8'>
   ...
   <div class="input-group">
     ...
     <input type="text" name="firstname" placeholder="Your first name" maxlength="30" value="<?php echo $firstname; ?>" required autofocus>
   </div> <br> <br>

   <div class="input-group">
     <label for="lastname"> <b> Last name </b> </label> <br>
     <input type="text" name="lastname" placeholder="Your last name" maxlength="30" value="<?php echo $lastname; ?>" required autofocus>
   </div> <br> <br>

   <div class="input-group">
     <label for="email"> <b> Email address </b> </label> <br>
      <input type="email" name="email" placeholder="example@email.com" maxlength="30" value="<?php echo $email; ?>" required autofocus>
   </div> <br> <br>

   <div class="input-group">
     <label for="password1"> <b> Password </b> </label> <br>
      <input type="password" name="password1" placeholder="At least 8 characters" maxlength="30" value="<?php echo $password1; ?>">
   </div> <br> <br>

    <div class="input-group">
      <label for="password2"> <b> Confirm password </b> </label> <br>
      <input type="password" name="password2" placeholder="Confirm password" maxlength="30" value="<?php echo $password2; ?>" required autofocus>
    </div> <br> <br>
